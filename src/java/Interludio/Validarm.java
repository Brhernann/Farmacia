...
public class Validarm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (crud.verificador(m)>0) {
                ...
                request.getSession().setAttribute("Mycodigo", codigo);
                request.getRequestDispatcher("ModificarmedicamentoDOS.jsp").forward(request, response);
        }
