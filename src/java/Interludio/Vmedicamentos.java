...
public class Vmedicamentos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getSession().setAttribute("medicamentos", listam);
        request.getRequestDispatcher("Vermedicamentos.jsp").forward(request, response);
