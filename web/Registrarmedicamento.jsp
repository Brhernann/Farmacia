<%--
    ...
    Created on : 08-jun-2016, 21:47:09
    ...
    <header>
        <nav class="navbar navbar-default navbar-static-top navbar-inverse">
            ...
            <div class=" col-lg-12">
             ...
             <form action="registrarmedicamento.do" method="POST">
                 
            <div class=" col-lg-4"></div>
            <div class="form-group col-lg-4 ">
                
                <h3><b>Nuevo medicamento</b></h3>
                <br>
                <input type="text" name="txtcodigo" value="" class="form-control" required autocomplete placeholder="Codigo" />
                <br>
                <input type="text" name="txtnombre" value=""class="form-control" required autocomplete placeholder="Nombre" />
                <br>
                <input type="text" name="txtstock" value="" class="form-control" required autocomplete placeholder="Stock" />
                <br>
                <input type="text" name="txtprecio" value="" class="form-control" required autocomplete placeholder="Precio $CLP" />
                <br>
                <input type="text" name="txttipo" value="" class="form-control" required autocomplete placeholder="Tipo" />
                <br>
