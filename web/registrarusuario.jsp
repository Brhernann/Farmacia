    ...
    Created on : 10-jun-2016, 21:34:46
    ...
    <nav class="navbar navbar-default navbar-static-top navbar-inverse">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-1">
             ...
             <form action="registrarc.do" method="POST">
                 
            <div class=" col-lg-4"></div>
            <div class="form-group col-lg-4 ">
                
                <h3><b>Pronto a ser uno de los nuestros</b></h3>
                <br>
                <input type="text" name="txtrut" value="${param.txtrut}" class="form-control" required autocomplete placeholder="Rut" />
                <br>
                <input type="text" name="txtnombre" value="" class="form-control" required autocomplete placeholder="Nombre" />
                <br>
                <input type="text" name="txtip" value=""class="form-control" required autocomplete placeholder="Institucion previsional" />
                <br>
                <input type="text" name="txtedad" value="" class="form-control" required autocomplete placeholder="Edad" />
                <br>
